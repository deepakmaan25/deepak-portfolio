      ...
      <div className="relative z-10 grid lg:grid-cols-[55%_45%] gap-12 items-center">
        ...
        <div>
          ...
          <motion.h1
            ...
            className="type-h1 mb-8">Designing Purposeful Digital Interactions
          ...
          <motion.p
            ...
            className="type-body-lg text-muted-foreground max-w-xl mb-10">Specializing in UX research, interaction design, and AI-powered workflows. I help to build scalable products with user backed research and insights.
