    ...
    <section id="contact" className="py-24 lg:py-32 bg-charcoal">
      <div className="px-6 lg:px-12 max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left */}
          <div>
            <span className="font-body text-xs font-medium tracking-[0.2em] uppercase text-terracotta mb-4 block">
              Let's Talk
            </span>
            ...
            <div className="mt-10 space-y-4">
              {[
                { label: "Email", value: "aria.sharma@email.com", href: "mailto:aria.sharma@email.com" },
                { label: "LinkedIn", value: "linkedin.com/in/ariasharma", href: "#" },
                { label: "Dribbble", value: "dribbble.com/ariasharma", href: "#" },
          ...
          <div className="bg-cream/5 border border-cream/10 p-10">
            ...
            <div className="space-y-4">
              <a
                href="mailto:aria.sharma@email.com"
      ...
      {/* Footer */}
      <div className="px-6 lg:px-12 max-w-6xl mx-auto mt-20 pt-8 border-t border-cream/10 flex items-center justify-between flex-wrap gap-4">
        <span className="font-body text-xs text-cream/30">
          © 2024 Aria Sharma. All rights reserved.
        </span>
