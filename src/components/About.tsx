    ...
    <section id="about" className="py-24 px-6 lg:px-8 max-w-site mx-auto">
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          >
            <div>
              <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(22,101,52,0.5)", marginBottom: 6 }}>Status</p>
              <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 18, fontWeight: 400, color: "#166534", lineHeight: 1.2 }}>
                Open to new <em style={{ fontStyle: "italic" }}>opportunities</em>
              </div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 11, fontWeight: 500, padding: "4px 10px", borderRadius: 100, background: "#DCFCE7", color: "#166534", border: "1px solid #BBF7D0", marginTop: 10 }}>
            ...
            <div style={{ textAlign: "right", flexShrink: 0 }}>
              <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 32, fontWeight: 400, color: "#166534", lineHeight: 1 }}>
                12<em style={{ fontStyle: "normal", fontSize: 18 }}>+</em>
              </div>
              <div style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "rgba(22,101,52,0.4)", marginTop: 3 }}>Projects</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          >
            <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(79,70,229,0.45)", marginBottom: 8 }}>Skills & Tools</p>
            <div style={{ fontFamily: "'DM Serif Display', serif", fontSize: 18, fontWeight: 400, color: "#1e1b4b", marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
              {skills.map(skill => (
                <span
                  key={skill}
                  style={{ fontSize: 11, fontWeight: 500, padding: "4px 10px", borderRadius: 100, background: "rgba(99,102,241,0.1)", color: "#4f46e5", border: "1px solid rgba(99,102,241,0.18)", cursor: "default", transition: "all 0.2s" }}
              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", gap: 12 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    ...
                    <div>
                      <div style={{ fontSize: 14, fontWeight: 600, color: isOpen ? "#6366f1" : "hsl(var(--foreground))", transition: "color 0.2s" }}>
                        {exp.company}
                      </div>
                      <div style={{ fontSize: 12, color: "#6366f1", marginTop: 2 }}>{exp.role}</div>
                    </div>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                    <span style={{ fontSize: 12, fontWeight: exp.current ? 600 : 400, color: exp.current ? "#6366f1" : "hsl(var(--muted-foreground))" }}>
                      {exp.duration}
                    </span>
                ...
                <div style={{ maxHeight: isOpen ? 200 : 0, overflow: "hidden", transition: "max-height 0.4s cubic-bezier(0.16,1,0.3,1)" }}>
                  <div style={{ padding: "0 20px 16px", borderTop: "1px solid rgba(99,102,241,0.08)" }}>
                    <div style={{ display: "flex", flexDirection: "column", gap: 5, paddingTop: 12 }}>
                      {exp.points.map((point, j) => (
                        <div key={j} style={{ display: "flex", gap: 8, fontSize: 13, color: "hsl(var(--muted-foreground))", lineHeight: 1.7 }}>
