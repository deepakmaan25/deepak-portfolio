  ...
  return (
    <section id="about">
      ...
      <div className="py-24 md:py-[96px]">
        ...
        <div
          ref={ref}
          className="px-6 max-w-site mx-auto pt-24 md:pt-[96px]"
          style={{
            opacity: visible ? 1 : 0,
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              ...
              <div className="space-y-5 type-body text-muted-foreground max-w-lg">
                <p>
                  I'm Deepak — a product designer crafting digital experiences
                  that balance user needs with business goals. I work at the
                  intersection of UX research, interface design, and AI-powered
                  creative workflows.
                </p>
                <p>
                  Great design starts before the first wireframe — in
                  conversations, in empathy, and in genuine curiosity about how
                  people think. I leverage AI tools as force multipliers for
                  research synthesis, ideation, and visual exploration.
                </p>
              </div>
              ...
              {/* Currently card */}
              <div
                className="mt-6 rounded-xl p-5 max-w-xs"
              ...
              >
                ...
                <div className="space-y-1 text-[14px] text-white leading-[2]">
            ...
            <div className="flex items-center justify-center">
              <div className="relative">
                ...
                {/* Full orbital rings */}
                <svg
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[440px] h-[440px] pointer-events-none"
                  viewBox="0 0 440 440"
                  fill="none"
                >
                  <circle
                ...
                {/* Photo circle */}
                <div
                  className="w-[280px] h-[280px] rounded-full relative z-10"
                  style={{
            ...
            {experiences.map((exp, i) => (
              ...
              >
                ...
                <div className="space-y-1">
                  {exp.points.map((p, j) => (
                    <p key={j} className="text-[14px] text-muted-foreground leading-[1.8]">
                      — {p}
                    </p>
                  ))}
                </div>
