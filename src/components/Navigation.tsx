  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
        ...
        <a
          href="#contact"
          className="hidden md:inline-flex items-center gap-2 text-sm font-medium font-body px-5 py-2.5 bg-charcoal text-cream hover:bg-terracotta transition-all duration-300"
        >
          Hire Me
        </a>
        ...
        >
          <span className={`block h-px w-6 bg-charcoal transition-all duration-300 ${menuOpen ? "rotate-45 translate-y-[7px]" : ""}`} />
      ...
      {menuOpen && (
        <div className="md:hidden bg-cream border-b border-border px-6 py-6 flex flex-col gap-4">
          ...
          <a
            href="#contact"
            onClick={() => setMenuOpen(false)}
            className="mt-2 inline-flex items-center justify-center text-sm font-medium font-body px-4 py-2.5 bg-charcoal text-cream hover:bg-terracotta transition-all duration-300"
          >
            Hire Me
          </a>
        </div>
