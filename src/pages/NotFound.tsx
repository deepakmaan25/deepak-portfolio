...
export default function NotFound() {
  return (
    <main style={{ minHeight: '100vh', backgroundColor: 'hsl(0,0%,98%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: f, padding: 32 }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} style={{ textAlign: 'center', maxWidth: 480 }}>
        ...
        <h1 style={{ fontFamily: f, fontSize: 'clamp(2rem,5vw,3.5rem)', fontWeight: 700, letterSpacing: '-0.025em', color: 'hsl(0,0%,8%)', margin: '0 0 16px', lineHeight: 1.1 }}>
          Page not found.
        </h1>
        <p style={{ fontFamily: fs, fontStyle: 'italic', fontWeight: 300, fontSize: 18, color: 'hsl(0,0%,45%)', margin: '0 0 40px' }}>
