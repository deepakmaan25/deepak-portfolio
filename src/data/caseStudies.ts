    ...
    reflection: {
      ...
      learnings: [
        ...
        },
        {
          ...
          description:
            "Buzztro is a new kind of shopping, but most of the PDP still looks like a normal PDP. Users already know how to buy things. The job was making the one new thing understandable, not reinventing everything else alongside it.",
        },
        {
      ...
      futureList: [
        ...
        "Redundant question auto-fill across the checkout: a pattern worth solving at the product level rather than leaving to individual users",
      ],
  ...
  // ─────────────────────────────────────────────
  {
    ...
    solutions: [
      ...
      },
      {
        ...
        body: [
          "I treated conversations as persistent contexts rather than temporary sessions, the same mental model students already had for their notes. Visual conversation cards per subject show a preview of the last message and a timestamp. Quick-switch between ongoing threads without losing context. Search for past explanations. Bookmarking for things worth keeping. Auto-categorization by subject with recently-accessed chats surfaced first.",
